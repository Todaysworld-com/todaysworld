...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-white">
      {/* Purple background with Carrd-style triangle pattern */}
      <div
      ...
      {/* Outer Carrd-style page card */}
      <div className="mx-auto max-w-6xl px-4 py-10 lg:py-16">
        <div className="rounded-3xl border-[8px] border-[#4D3E5C] bg-black/40 px-4 py-8 shadow-[0_10px_0_#4D3E5C] backdrop-blur-lg lg:px-10 lg:py-10">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            ...
            <section className="flex-1 space-y-6">
              ...
              {/* video card with border */}
              <div className="relative w-full max-w-3xl rounded-3xl border-[6px] border-[#4D3E5C] bg-black/80 p-1 shadow-[0_8px_0_#4D3E5C]">
            ...
            <section className="flex w-full max-w-md flex-1 flex-col gap-5">
              {/* Chat card */}
              <div className="rounded-3xl border-[6px] border-[#4D3E5C] bg-black/75 p-4 shadow-[0_8px_0_#4D3E5C] backdrop-blur-xl">
